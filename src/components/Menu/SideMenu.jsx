    ...
    <>
      ...
      <div className={`side-menu ${isOpen ? 'open' : ''}`}>
        ...
        <ul className="menu-items">
          ...
          <li><i className="fas fa-key"></i> RUTAS</li>
          <li><i className="fas fa-bell"></i> NOTIFICACIONES</li>
          <li><i className="fas fa-lightbulb"></i> SUGERENCIAS</li>
          <li><i className="fas fa-headset"></i> ATENCIÓN AL CLIENTE</li>
